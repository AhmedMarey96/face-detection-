...
face_cascade = cv2.CascadeClassifier('/home/marey/opencv-3.4.4/data/haarcascades_cuda/haarcascade_frontalface_default.xml')
# Trained XML file for detecting eyes
eye_cascade = cv2.CascadeClassifier('/home/marey/opencv-3.4.4/data/haarcascades_cuda/haarcascade_eye.xml')
...
while 1: 
      ...
      # pub = rospy.Publisher("std_msgsstd_msgsframes", Image, queue_size=10)

        pub = rospy.Publisher("person_ava",Bool ,queue_size=10)
